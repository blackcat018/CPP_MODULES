...
ClapTrap::~ClapTrap()
{
    std::cout << "The clapTrap desctuctoooooor!" << std::endl;
}
...
void ClapTrap::attack(const std::string& target)
{
    ...
    energyPoints--;
    std::cout << "clap trap " << Name << " Attacks " << target << " causing it " << attackDmg<< " damage!" <<std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    std::cout << "ClapTrap" << " has taken " << amount << " points of damage! please consider repairing asap!" <<std::endl; 
}
